-- Fix Work Orders RLS - COMPLETE SOLUTION
-- Migration ini fix semua masalah RLS untuk work_orders
-- JALANKAN MIGRATION INI, bukan migration 019!
...
-- STEP 2: Drop SEMUA policy work_orders yang ada (bersihkan semua)
